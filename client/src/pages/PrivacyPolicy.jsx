          ...
          <div className="mt-5">
            <p className="text-secondary">
              ...
              <p>
                ...
                "Our" in this Agreement) refers to SiaraProperties.com,
                Jabalpur, Madhya pradesh INDIA 482002.
              </p>
              Company (referred to as either "the Company", "We", "Us" or "Our"
              in this Agreement) refers to SiaraProperties.com, Jabalpur, Madhya
              ...
              in analyzing how the Service is used.<br></br>
              Usage Data refers to data collected automatically, either
              generated by the use of the Service or from the Service
              infrastructure itself (for example, the duration of a page visit).
              <br></br>
              Website refers to SiaraProperties.com, accessible from
              https://siaraproperty.siarasystems.com/ <br></br>
              You means the individual accessing or using the Service, or the
              company, or other legal entity on behalf of which such individual
              is accessing or using the Service, as applicable.<br></br>
              <br></br>
              ...
              Service may use Cookies. <br></br>• Web Beacons. Certain sections
              ...
              cookies on TermsFeed website article.<br></br>
              <br></br>
              ...
              to provide You with those services. <br></br>
              ...
              re-enter your preferences every time You use the Website.<br></br>
              <br></br>
              For more information about the cookies we use and your choices
              regarding cookies, please visit our Cookies Policy or the Cookies
              section of our Privacy Policy.<br></br> <br></br>
              <h5 className="text-black">Use of Your Personal Data</h5>{" "}
              <br></br>
              The Company may use Personal Data for the following purposes:{" "}
              <br></br> <br></br>
              To provide and maintain our Service, including to monitor the
              usage of our Service. <br></br>
              ...
              when necessary or reasonable for their implementation. <br></br>
              ...
              and your experience. <br></br> <br></br>
              We may share Your personal information in the following
              situations: <br></br> <br></br>• With Service Providers: We may
              share Your personal information with Service Providers to monitor
              and analyze the use of our Service, to contact You. <br></br>• For
              business transfers: We may share or transfer Your personal
              information in connection with, or during negotiations of, any
              merger, sale of Company assets, financing, or acquisition of all
              or a portion of Our business to another company. <br></br>• With
              ...
              control or that are under common control with Us. <br></br>• With
              business partners: We may share Your information with Our business
              partners to offer You certain products, services or promotions.{" "}
              <br></br>• With other users: when You share personal information
              or otherwise interact in the public areas with other users, such
              information may be viewed by all users and may be publicly
              distributed outside. <br></br>• With Your consent: We may disclose
              ...
              <br></br>
              <h5 className="text-black"> Delete Your Personal Data</h5>{" "}
              <br></br>
              ...
              "Last updated" date at the top of this Privacy Policy. <br></br>
              You are advised to review this Privacy Policy periodically for any
              changes. Changes to this Privacy Policy are effective when they
              are posted on this page.<br></br>
              <br></br>
              <h5 className="text-black"> Contact Us</h5>
              <br></br>
              If you have any questions about this Privacy Policy, You can
              contact us: <br></br>• By phone number: +918839280515 <br></br>
            </p>
