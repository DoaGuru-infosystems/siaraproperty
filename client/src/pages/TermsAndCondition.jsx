    ...
    <div className="nav1"></div>
      ...
      <div className="mt-5">
        ...
        <p className='text-secondary'>
              Welcome to SiaraProperties.com! <br></br>
              These terms and conditions outline the rules and regulations for the use of SiaraProperties's Website, located at https://siaraproperties.com//.
<br></br>
              By accessing this website we assume you accept these terms and conditions. Do not continue to use SiaraProperties.com if you do not agree to take all of the terms and conditions stated on this page. <br></br>
The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all Agreements: "Client", "You" and "Your" refers to you, the person log on this website and compliant to the Company's terms and conditions. "The Company", "Ourselves", "We", "Our" and "Us", refers to our Company. "Party", "Parties", or "Us", refers to both the Client and ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner for the express purpose of meeting the Client's needs in respect of provision of the Company's stated services, in accordance with and subject to, prevailing law of in. Any use of the above terminology or other words in the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.
      ...
      <div className="mt-5">
         <h5>Cookies</h5>
        <p className='text-secondary'>
              We employ the use of cookies. By accessing SiaraProperties.com, you agreed to use cookies in agreement with the SiaraProperties's Privacy Policy. <br></br>
Most interactive websites use cookies to let us retrieve the user's details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.
      ...
      <div className="mt-5">
        ...
        You must not:<br></br>
              •	Republish material from SiaraProperties.com <br></br>
              •	Sell, rent or sub-license material from SiaraProperties.com <br></br>
              •	Reproduce, duplicate or copy material from SiaraProperties.com <br></br>
              •	Redistribute content from SiaraProperties.com <br></br>
This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the Free Terms and Conditions Generator.<br></br>
              Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. bharat roofers does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of bharat roofers,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, SiaraProperties shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.<br></br>
              SiaraProperties reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.<br></br>
...
•	The Comments will not be used to solicit or promote business or custom or present commercial activities or unlawful activity.<br></br>
              You hereby grant SiaraProperties a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.<br></br>
