        ...
        <div className="container mt-5">
          ...
          <div className="mt-5">
            <p className="text-secondary">
              ...
              the use of SiaraProperties's Website, located at
              https://siaraproperty.siarasystems.com//.
              <br></br>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use SiaraProperties.com if you do
          ...
          <div className="mt-5">
            <h5>Cookies</h5>
            <p className="text-secondary">
              We employ the use of cookies. By accessing SiaraProperties.com,
              you agreed to use cookies in agreement with the SiaraProperties's
          ...
          <div className="mt-5">
            <p className="text-secondary">
              You must not:<br></br>• Republish material from
              SiaraProperties.com <br></br>• Sell, rent or sub-license material
              from SiaraProperties.com <br></br>• Reproduce, duplicate or copy
              material from SiaraProperties.com <br></br>• Redistribute content
              from SiaraProperties.com <br></br>
              ...
              bharat roofers does not filter, edit, publish or review Comments
              prior to their presence on the website. Comments do not reflect
              the views and opinions of bharat roofers,its agents and/or
              ...
              applicable laws, SiaraProperties shall not be liable for the
              ...
              SiaraProperties reserves the right to monitor all Comments and to
              remove any Comments which can be considered inappropriate,
              offensive or causes breach of these Terms and Conditions.<br></br>
              You warrant and represent that:<br></br>• You are entitled to post
              the Comments on our website and have all necessary licenses and
              consents to do so; <br></br>• The Comments do not invade any
              intellectual property right, including without limitation
              copyright, patent or trademark of any third party;<br></br>• The
              Comments do not contain any defamatory, libelous, offensive,
              indecent or otherwise unlawful material which is an invasion of
              privacy<br></br>• The Comments will not be used to solicit or
              promote business or custom or present commercial activities or
              unlawful activity.<br></br>
              You hereby grant SiaraProperties a non-exclusive license to use,
          ...
          <div className="mt-5">
            ...
            <p className="text-secondary">
              ...
              bound to and follow these linking terms and conditions.<br></br>
            </p>
          ...
          <div className="mt-5">
            ...
            <p className="text-secondary">
              ...
              <br></br>• limit or exclude our or your liability for death or
              personal injury; <br></br>• limit or exclude our or your liability
              for fraud or fraudulent misrepresentation;<br></br>• limit any of
              our or your liabilities in any way that is not permitted under
              applicable law; or<br></br>• exclude any of our or your
