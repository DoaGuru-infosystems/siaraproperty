...
export default function ResaleProperty() {
  ...
  const getAllProperties = async () => {
    try {
      const response = await axios.get(
        `https://siaraproperty.siarasystems.com//api/property/getPropertyForResaleByType/${propertyType}`,
      );
  ...
  const getAllPropertiesImages = async () => {
    try {
      const response = await axios.get(
        "https://siaraproperty.siarasystems.com//api/property/getAllPropertyImages",
      );
      ...
      <div className="mb-4 mt-5 pt-5">
        <h3 className="post-heading fw-semibold mb-3 ms-lg-3">
          <p className="text-uppercase text-center">
            Available {`${propertyType}s`} For Resale
          </p>
        </h3>
                      ...
                      <div className="card-body address">
                        ...
                        <p className="card-text">
                          <small className="text-body-secondary">
                            ...
                            posted on : {moment(property.created_at).fromNow()}
                          </small>
                        </p>
                      </div>
                    </div>
